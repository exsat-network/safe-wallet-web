...
import * as protocolKit from '@exsat/test-protocol-kit'
import * as protocolKitContracts from '@exsat/test-protocol-kit/dist/src/contracts/safeDeploymentContracts'
...
} from '@exsat/test-protocol-kit/dist/src/types'
